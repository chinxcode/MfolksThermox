        ...
        <div className="p-4 md:p-6 space-y-6">
            ...
            <div className="pb-4 border-b border-neutral-100 dark:border-neutral-700">
                ...
                {(Array.isArray(currentVariant.variantPriceType)
                    ...
                    : currentVariant.variantPriceType === "on_request") || !currentVariant.variantPrice ? (
                    ...
                    <>
                        <div className="flex items-baseline gap-1">
                            ...
                            <span className="text-sm text-neutral-500 font-medium">/{currentVariant.variantPriceUnit || "unit"}</span>
                        </div>
                        {currentVariant.variantPriceLastUpdated && (
                            <p className="text-xs text-neutral-400 mt-1 flex items-center gap-1">
                                ...
                                Updated:{" "}
                                {new Date(currentVariant.variantPriceLastUpdated).toLocaleDateString("en-IN", {
                                    year: "numeric",
                                    month: "short",
                                    day: "numeric",
                                })}
            ...
            <div className="space-y-3">
                ...
                <div className="text-xs text-neutral-500 flex justify-between px-1">
                    <span>
                        SKU: <span className="font-mono text-neutral-700 dark:text-neutral-300">{currentVariant.variantSku}</span>
                    </span>
            ...
            <div className="pt-2 space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                    <button
                        ...
                        className={`w-full py-3.5 px-4 rounded-xl font-bold text-center transition-all duration-300 shadow-lg ${
                            added
